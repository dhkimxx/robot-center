...
func (s *Store) WithTransaction(ctx context.Context, run func(ctx context.Context, repository repo.Store) error) error {
...
func (s *Store) nextCodeWithGorm(tx *gorm.DB, prefix string, tableName string) (string, error) {
	var count int64
...
func (s *Store) nextCode(ctx context.Context, tx *sql.Tx, prefix string, tableName string) (string, error) {
	var count int
