...
type SensorDataClearResult struct {
	SensorLatestSamplesDeleted int64 `json:"sensorLatestSamplesDeleted"`
	SensorSamplesDeleted       int64 `json:"sensorSamplesDeleted"`
	SensorDescriptorsDeleted   int64 `json:"sensorDescriptorsDeleted"`
}
...
type SensorStore interface {
	...
	ClearSensorData(ctx context.Context) (SensorDataClearResult, error)
}
