...
func (s *Server) Handler() http.Handler {
	...
	mux.HandleFunc("GET /api/docs", redirectTo("/swagger/index.html"))
	mux.HandleFunc("GET /api/docs/openapi.json", redirectTo("/swagger/openapi.json"))
	mux.HandleFunc("GET /api/v1/system/docs", redirectTo("/swagger/index.html"))
	mux.HandleFunc("GET /api/v1/system/openapi.json", redirectTo("/swagger/openapi.json"))
