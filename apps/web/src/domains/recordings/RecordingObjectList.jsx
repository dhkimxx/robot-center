...
function RecordingObjectEntry({ entry, onOpenPlaybackFile, recording }) {
  return (
    <div
    ...
    >
      <div className="min-w-0">
        ...
        <span className="mt-1 block break-words text-xs font-semibold leading-snug text-slate-400">
          {makeRecordingFileAvailabilityNote(entry)}
        </span>
      </div>
