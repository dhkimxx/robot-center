...
- '2026-06-08 danya.kim <danya.kim@thundersoft.com>: clarify event v0 is live-only and not persisted'
---
...
| `channel.event` | 현재 sensor 저장 대상 아님. event v0는 Live UI 표시 전용이며 DB 저장은 후속 범위 | JSONL 저장 안 함 |
