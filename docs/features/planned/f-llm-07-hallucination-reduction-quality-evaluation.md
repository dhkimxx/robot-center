---
title: "F-LLM-07 Hallucination 저감 및 품질 평가"
created: 2026-06-04
updated: '2026-06-04'
...
type: "feature"
status: "planned"
tags: ["feature", "f_llm", "f-llm-07", "planned"]
history:
...
# F-LLM-07 Hallucination 저감 및 품질 평가
...
SOP/RAG grounding, confidence 표시, operator 승인, 결과 피드백 수집

## 원본 XLSX 상세 설명

RAG(Retrieval Augmented Generation) 적용 - SOP/매뉴얼 기반 Grounding, 생성 결과 Fact-checking 파이프라인, Confidence Score 표시, Human-in-the-loop 검증(고위험 제안), 피드백 수집→프롬프트 개선 루프.
