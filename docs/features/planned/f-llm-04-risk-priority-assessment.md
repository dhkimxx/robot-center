---
title: "F-LLM-04 위험도 분석 및 우선순위 판정"
created: 2026-06-04
updated: '2026-06-04'
...
type: "feature"
status: "planned"
tags: ["feature", "f_llm", "f-llm-04", "planned"]
history:
...
가스, 온도, 위치, detection event 기반 위험도 계산 및 표시. 최종 판단/제어는 operator 승인

## 원본 XLSX 상세 설명

다차원 위험도 평가(가스농도/온도/구조안정성/접근성), 생존자 탐지 우선순위 스코어링(생존가능성/접근용이성/시간경과), 위험지역 히트맵 생성, 지휘관 의사결정 지원 정보 제공.
